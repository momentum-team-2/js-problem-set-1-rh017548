...
function isOdd(num) { return num % 2 === 1 || num % 2 === -1 }
...
function fahrenheitToCelsius(num) {return (num - 32) * (5/9)}
...
function celsiusToFahrenheit(num) {return (num * (9/5)) + 32}
...
function fahrenheitToKelvin(num) {return (num - 32) * (5/9) + 273.15}

// 8. Create a function called lesser that takes two numbers as
// arguments and returns the lesser of them. This function should
// use an if/else statement.
function lesser(num1, num2) {if (num1 < num2) {return num1} else { return num2 }}
